...
targetDir.name    = 'Target directory combined files';
targetDir.help    = {'Where do you want to move the combined files to, if anywhere?'};
...
dmb_menu_combine_echoes.val       = {data combine_method echo_times pre_vols n_pre_vols dir_PAIDweight, expected_n_sessions, targetDir};
