...
dmb_menu_combine_echoes.values      = {dmb_item_spm_realign_estimate, dmb_item_copy_realignment_pars, dmb_item_combine_sessions, dmb_item_spm_realignment_write, dmb_item_split_sessions, dmb_item_combine_echoes, dmb_spm_cfg_realign_estimate};
