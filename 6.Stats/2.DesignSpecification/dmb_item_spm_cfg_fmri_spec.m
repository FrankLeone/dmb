function fmri_spec = dmb_item_spm_cfg_fmri_spec
...
fmri_spec.val     = {dir timing sess generic1 bases volt xGlobal mask cvi expected_n_sessions};
fmri_spec.help    = {
...
fmri_spec.prog = @dmb_run_spm_fmri_spec;
